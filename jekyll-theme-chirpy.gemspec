...
Gem::Specification.new do |spec|
  ...
  tracked_files = Dir.glob("{_includes,_layouts,_sass,_data/{locales,origin},assets}/**/*", File::FNM_DOTMATCH) +
                  %w[README.md LICENSE] if tracked_files.empty?
  spec.files = tracked_files.select { |f|
